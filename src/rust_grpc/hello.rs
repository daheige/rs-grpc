...
pub mod greeter_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn healthz(
            ...
            req.extensions_mut().insert(GrpcMethod::new("Hello.Greeter", "Healthz"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/Hello.Greeter/Healthz" => {
                    ...
                    impl<T: Greeter> tonic::server::UnaryService<super::HealthzReq>
                    for HealthzSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Greeter>::healthz(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
